...
class SubsidyDebitOrder(models.Model):
    ...
    def get_empty_list_help(self, help):
        ...
        return super(SubsidyDebitOrder, self).get_empty_list_help(help)
    ...
    order_line = fields.One2many('subsidy.debit.order.line', 'order_id', string='Order Lines', states={'cancel': [('readonly', True)], 'done': [('readonly', True)]}, copy=True, auto_join=True)
    ...
    def _compute_access_url(self):
        super(SubsidyDebitOrder, self)._compute_access_url()
        for order in self:
    ...
    def unlink(self):
        ...
        return super(SubsidyDebitOrder, self).unlink()
    ...
    def _track_subtype(self, init_values):
        ...
        return super(SubsidyDebitOrder, self)._track_subtype(init_values)
    ...
    def create(self, vals):
        ...
        result = super(SubsidyDebitOrder, self).create(vals)
        return result
    ...
    def _write(self, values):
        ...
        if self.env.context.get('mail_activity_automation_skip'):
            return super(SubsidyDebitOrder, self)._write(values)
    ...
    def copy_data(self, default=None):
        ...
        return super(SubsidyDebitOrder, self).copy_data(default)
    ...
    def name_get(self):
        if self._context.get('sale_show_partner_name'):
            ...
            return res
        return super(SubsidyDebitOrder, self).name_get()
    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        return super(SubsidyDebitOrder, self)._name_search(name, args=args, operator=operator, limit=limit, name_get_uid=name_get_uid)
    ...
    def _get_share_url(self, redirect=False, signup_partner=False, pid=None):
        ...
        return super(SubsidyDebitOrder, self)._get_share_url(redirect, signup_partner, pid)
...
class SubsidyDebitOrderLine(models.Model):
    _name = 'subsidy.debit.order.line'
    ...
    def create(self, values):
        ...
        line = super(SubsidyDebitOrderLine, self).create(values)
    ...
    def write(self, values):
        ...
        result = super(SubsidyDebitOrderLine, self).write(values)
        return result
    ...
    order_id = fields.Many2one('subsidy.debit.order', string='Order Reference', required=True, ondelete='cascade', index=True,
    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        return super(SubsidyDebitOrderLine, self)._name_search(name, args=args, operator=operator, limit=limit,
    ...
    def unlink(self):
        ...
        return super(SubsidyDebitOrderLine, self).unlink()
